...
#define TRIGER_DELTA 10 // threshold value to determine movement
int x0=0;
int y0=0;
int z0=0; // old value for x,y,z
...
void readAccel() {
  ...
  if((x-x0)>=TRIGER_DELTA||(x0-x)>=TRIGER_DELTA||(y-y0)>=TRIGER_DELTA||(y0-y)>=TRIGER_DELTA||(z-z0)>=TRIGER_DELTA||(z0-z)>=TRIGER_DELTA)
